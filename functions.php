...
function mission_atletica_resources() {
	...
	wp_enqueue_style( 'mawp-bootstrap-css', get_template_directory_uri() . '/assets/css/vendor/bootstrap.min.css', array(), '3.3.0' );
	wp_enqueue_style( 'bootstrap-select-style', get_template_directory_uri() . '/assets/css/vendor/bootstrap-select.min.css', array(), '1.6.3' );
	...
	wp_enqueue_script( 'mawp-bootstrap-js', get_template_directory_uri() . '/assets/js/vendor/bootstrap.min.js', array( 'jquery' ), '3.3.0', true );
	wp_enqueue_script( 'bootstrap-select-js', get_template_directory_uri() . '/assets/js/vendor/bootstrap-select.min.js', array( 'jquery' ), '1.6.3', true );
